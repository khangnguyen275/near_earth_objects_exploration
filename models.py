...
class NearEarthObject:
    ...
    def __init__(self, pde : str, **info):
        ...
        :parammeters:
            ...
            info: keyword arguments
                Additional information about the NEO such as name, diameter, hazardous, etc.
        """
    ...
    def __str__(self):
        ...
        return f"A NearEarthObject with full name {self.fullname}. " \
                f"It has a diameter of {self.diameter:.2f} km and {tobe} hazardous."
...
class CloseApproach:
    ...
    def __init__(self, time: str, distance, velocity, _designation: str):
        ...
        :parameters:
            time : string
                NASA-formatted calendar date/time description using the English locale's month names.
            distance : string or float
                Nominal approach distance in au of the NEU to Earth at the closest point.
            velocity : string or float
                Velocity in km/s of the NEO relative to Earth at the closest point.
            _designation: string
